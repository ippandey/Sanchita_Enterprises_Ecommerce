  ...
  return (
    <div className="px-4 md:px-10 lg:px-20 my-10">
      ...
      <div className="mb-10">
        ...
        <h1 className="text-3xl md:text-[44px] font-cormorant italic">
          Shop By Categories
        </h1>
      </div>
      ...
      >
        {CategoryList.map((item, index) => (
          <motion.div
            key={index}
            className="relative text-center overflow-hidden cursor-pointer w-full h-[250px] flex items-center justify-center"
            initial={{ opacity: 0, x: -50 }}
            whileInView={{
              opacity: 1,
              x: 0,
          ...
          >
            ...
            >
              ...
              <p className="text-white font-work text-sm mt-2">
                {item.products} Items
              </p>
            </motion.div>
          </motion.div>
