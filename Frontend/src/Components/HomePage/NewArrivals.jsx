    ...
    <section className="overflow-hidden relative">
      <div className="px-4 sm:px-8 md:px-20 py-12">
        ...
        >
          ...
          <motion.h1
            className="text-[32px] sm:text-[40px] md:text-[44px] font-cormorant capitalize text-[#202025]"
            variants={{
              hidden: { opacity: 0, y: 50 },
              visible: {
                opacity: 1,
        ...
        <motion.div
          className="flex flex-row md:grid md:grid-cols-4 gap-5 overflow-x-auto md:overflow-visible scroll-smooth snap-x snap-mandatory md:snap-none"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
          variants={{
        ...
        >
          {newArrivals.map((product) => (
            ...
            >
              <AnimatePresence>
                <motion.div
                  className="border p-4 shadow-md rounded-lg relative bg-white"
                  onMouseEnter={() => setHoveredProductId(product._id)}
                  onMouseLeave={() => setHoveredProductId(null)}
                  variants={{
                    hidden: { opacity: 0, y: 50 },
                ...
                >
                  ...
                  <img
                    ...
                    alt={product.title}
                    className="w-full h-48 object-cover mb-4 rounded-md transition-all"
                  />
                  <h3 className="text-lg font-medium text-center font-work text-[#333333]">
                    {product.title}
                  </h3>
